      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="space-y-1.5">
            ...
            <Input id="firstName" className="h-10 bg-gray-50/50 border-gray-200 focus:bg-white transition-colors text-sm" {...register("firstName")} />
            {errors.firstName && (
          ...
          <div className="space-y-1.5">
            ...
            <Input id="lastName" className="h-10 bg-gray-50/50 border-gray-200 focus:bg-white transition-colors text-sm" {...register("lastName")} />
            {errors.lastName && (
        ...
        <div className="space-y-1.5">
          ...
          <Input id="email" type="email" placeholder="john@example.com" className="h-10 bg-gray-50/50 border-gray-200 focus:bg-white transition-colors text-sm" {...register("email")} />
          {errors.email && (
        ...
        <div className="space-y-1.5">
          ...
          <Input id="password" type="password" className="h-10 bg-gray-50/50 border-gray-200 focus:bg-white transition-colors text-sm" {...register("password")} />
          {errors.password && (
        ...
        <div className="space-y-1.5">
          ...
          <Input id="confirmPassword" type="password" className="h-10 bg-gray-50/50 border-gray-200 focus:bg-white transition-colors text-sm" {...register("confirmPassword")} />
